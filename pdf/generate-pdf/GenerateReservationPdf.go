...
func GenerateAndSendReservationPDF(htmlFile, pdfFile string, customerName string, customerEmail string, resDate, resTime string, numberOfPersons int64, totalPrice float64, allfoodNames string) error {
	...
	err = GenerateReservationPDF(htmlFile, pdfFile, customerName, customerEmail, resDate, resTime, numberOfPersons, totalPrice, allfoodNames)
	if err != nil {
...
func GenerateReservationPDF(htmlFile, outputPath string, customerName string, customerEmail string, resDate, resTime string, numberOfPersons int64, totalPrice float64, allfoods string) error {
